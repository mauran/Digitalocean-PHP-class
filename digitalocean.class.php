...
class digitalOcean
{
    ...
    public function newDroplet($name, $sizeId, $imageId, $regionId, $ssh_key_ids = null, $private_networking = null)
    {
        ...
        if (self::validateSize($sizeId) == false) {
            ...
            $parameters = ['name' => $name, 'size_id' => $sizeId, 'image_id' => $imageId, 'region_id' => $regionId];
    ...
    public function destroyDroplet($dropletId)
    {
        ...
        return self::request('/droplets/'.$dropletId.'/destroy', ['scrub_data' => true]);
    }
    ...
    {
        $parameters = ['name' => $name, 'ssh_pub_key' => $ssh_pub_key];
    ...
    {
        $parameters = ['ssh_pub_key' => $ssh_pub_key];
